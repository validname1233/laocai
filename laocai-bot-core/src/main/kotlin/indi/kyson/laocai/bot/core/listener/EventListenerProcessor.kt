...
import indi.kyson.laocai.bot.core.annotation.MatchType
import indi.kyson.laocai.bot.core.annotation.MultiFilter
...
class EventListenerProcessor {
     ...
     * @param method 被 [indi.kyson.laocai.bot.core.annotation.Listener] 注解的方法
     * @param beanProvider 按 beanName 获取实例的函数，由容器实现方（如 Spring）提供，使 core 不依赖具体容器
     */
    fun process(
        beanName: String,
        method: Method,
